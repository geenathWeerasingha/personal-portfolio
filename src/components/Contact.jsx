        ...
        >
          ...
          <div className="grid sm:grid-cols-2 gap-6 mb-12">
            ...
            <a
              ...
              className="glass-card p-6 hover:border-cyan-500/50 transition-all duration-300 group"
            >
              <div className="w-14 h-14 mx-auto mb-4 bg-[#0A66C2]/10 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
            ...
            <a
              ...
              className="glass-card p-6 hover:border-cyan-500/50 transition-all duration-300 group"
            >
              <div className="w-14 h-14 mx-auto mb-4 bg-cyan-500/10 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                <svg className="w-7 h-7 text-cyan-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
              </div>
              <h3 className="text-white font-semibold mb-1">Email</h3>
              <p className="text-slate-500 text-sm">geenathweer1@gmail.com</p>
            </a>
          </div>

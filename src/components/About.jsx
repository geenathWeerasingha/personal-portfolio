          ...
          <div className="grid lg:grid-cols-5 gap-12 items-center">
            ...
            <div className="lg:col-span-2 flex justify-center">
              <div className="relative">
                {/* Decorative elements */}
                <div className="absolute -inset-4 bg-gradient-to-r from-cyan-500/20 to-teal-500/20 rounded-2xl blur-xl" />
                <div className="relative glass-card p-8">
                  <div className="w-48 h-48 relative">
                    ...
                    <div className="absolute inset-0 flex flex-col justify-center gap-2">
                      ...
                      <div className="h-2 bg-slate-600/60 rounded-full w-full" />
                      <div className="h-2 bg-teal-500/60 rounded-full w-1/2" />
                      <div className="h-2 bg-slate-600/60 rounded-full w-5/6" />
                      <div className="h-2 bg-cyan-500/40 rounded-full w-2/3" />
                      <div className="h-2 bg-slate-600/60 rounded-full w-full" />
                      <div className="h-2 bg-teal-500/40 rounded-full w-3/4" />
                    </div>
                    {/* Overlay icons */}
                    <div className="absolute top-4 right-4 w-10 h-10 bg-cyan-500/20 rounded-lg flex items-center justify-center">
                      <svg className="w-5 h-5 text-cyan-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                      </svg>
                    </div>
                    <div className="absolute bottom-4 left-4 w-10 h-10 bg-teal-500/20 rounded-lg flex items-center justify-center">
            ...
            <div className="lg:col-span-3 space-y-6">
              ...
              <div className="flex flex-wrap gap-6 pt-4">
                ...
                <div className="text-center">
                  <p className="text-2xl font-bold text-cyan-400">AI/ML</p>

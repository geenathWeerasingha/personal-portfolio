                ...
                <div className="relative glass-card p-8">
                  <div className="w-48 h-48 relative">
                    ...
                    <div className="absolute inset-0 flex flex-col justify-center gap-2">
                      <div className="h-2 bg-cyan-500/60 dark:bg-cyan-400/60 rounded-full w-3/4" />
                      <div className="h-2 bg-slate-300 dark:bg-slate-600 rounded-full w-full" />
                      <div className="h-2 bg-teal-500/60 dark:bg-teal-400/60 rounded-full w-1/2" />
                      <div className="h-2 bg-slate-300 dark:bg-slate-600 rounded-full w-5/6" />
                      <div className="h-2 bg-cyan-500/40 dark:bg-cyan-400/40 rounded-full w-2/3" />
                      <div className="h-2 bg-slate-300 dark:bg-slate-600 rounded-full w-full" />
                      <div className="h-2 bg-teal-500/40 dark:bg-teal-400/40 rounded-full w-3/4" />
                    </div>
                    {/* Overlay icons */}
                    <div className="absolute top-4 right-4 w-10 h-10 bg-cyan-500/10 dark:bg-cyan-400/20 rounded-lg flex items-center justify-center">
                    ...
                    <div className="absolute bottom-4 left-4 w-10 h-10 bg-teal-500/10 dark:bg-teal-400/20 rounded-lg flex items-center justify-center">
            ...
            <div className="lg:col-span-3 space-y-6">
              ...
              <div className="flex flex-wrap gap-6 pt-4">
                <div className="text-center">
                  <p className="text-2xl font-bold text-cyan-600 dark:text-cyan-400">1+</p>
                  <p className="text-sm text-slate-500 dark:text-slate-500">Years Experience</p>
                </div>
                <div className="text-center">
                  <p className="text-2xl font-bold text-cyan-600 dark:text-cyan-400">AWS</p>
                  <p className="text-sm text-slate-500 dark:text-slate-500">Cloud Platform</p>
                </div>
                <div className="text-center">
                  <p className="text-2xl font-bold text-cyan-600 dark:text-cyan-400">AI/ML</p>
                  <p className="text-sm text-slate-500 dark:text-slate-500">Specialization</p>
                </div>
              </div>
            </div>
          </div>
